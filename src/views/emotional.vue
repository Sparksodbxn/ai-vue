<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="nickname" label="会话ID" width="80">
      ...
      <el-table-column prop="diaryContent" label="日记内容"></el-table-column>
      <!-- 操作是自定义内容 使用插槽-->
       <el-table-column label="操作" width="240px" fixed="right">
        <template #default="scope">
          <el-button text @click="viewSessionDetail(scope.row)" type="primary" >详情</el-button>
    ...
    >
      <div class="detail-content" v-if="currentDetail">
        ...
        <div class="detail-section">
          ...
          <div class="ai-analysis-result">
            ...
            <el-descriptions-item label="情绪强度">
              <el-progress :percentage="aiData.emotionScore" :stroke-width="8" :color="getEmotionScoreColor(aiData.emotionScore)"></el-progress>
            </el-descriptions-item>
            <el-descriptions-item label="风险等级">
              <el-tag :type="getAiEmotionTagType(aiData.riskLevel)">{{ aiData.riskLevel }}</el-tag>
            </el-descriptions-item>
            <el-descriptions-item label="情绪性质">
              <el-tag :type="aiData.isNegative?'dange':'success'">{{ aiData.isNegative ? '负面' : '正面' }}</el-tag>
            </el-descriptions-item>
          </el-descriptions>
        ...
        <div class="detail-section">
          <h4>时间信息</h4>
          <el-descriptions :column="2" border>
            <el-descriptions-item label="创建日期">{{ currentDetail.createdAt }}</el-descriptions-item>
