   ...
   <div class="frontend-layout">
    <div class="navbar-container">
      <div class="brand-section">
        <el-image :src="iconUrl" style="width: 50px;height: 50px;" alt="品牌logo" class="brand-logo"></el-image>
      ...
      <div class="nav-section">
        ...
        <el-button v-if="isLoggedIn" @click="handleLogout" class="logout-btn">退出登录</el-button>
        <template v-else>
